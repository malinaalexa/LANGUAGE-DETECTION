...
namespace SentimentAnalysis
{
    class Program
    {
        ...
        private static void UseModelWithSingleItem(MLContext mlContext, ITransformer model)
        {
            ...
            {
                SentimentText = "Me voy de vacaciones la próxima semana"
            };
            // </SnippetCreateTestIssue1>
            ...
            Console.WriteLine();
            Console.WriteLine($"Sentiment: {resultPrediction.SentimentText} | Prediction: {(Convert.ToBoolean(resultPrediction.Prediction) ? "English" : "Spanish")} | Probability: {resultPrediction.Probability} ");
        ...
        public static void UseModelWithBatchItems(MLContext mlContext, ITransformer model)
        {
            ...
            IEnumerable<SentimentData> sentiments = new[]
            {
                 new SentimentData
                {
                    SentimentText = "What's the cost of a ticket?"
                },
                new SentimentData
                {
                ...
                new SentimentData
                {
                    SentimentText = "Voy a la tienda."
                },
                new SentimentData
                {
                    SentimentText = "Can I try this on?"
                },
                new SentimentData
                {
                    SentimentText = "De dónde eres?"
                }
            };
            // </SnippetCreateTestIssues>
            ...
            foreach (SentimentPrediction prediction in predictedResults)
            {
                ...
                Console.WriteLine(Convert.ToBoolean(prediction.Prediction));

                Console.WriteLine($"Sentiment: {prediction.SentimentText} | Prediction: {(Convert.ToBoolean(prediction.Prediction) ? "English" : "Spanish")} | Probability: {prediction.Probability} ");
            }
            Console.WriteLine("=============== End of predictions ===============");
            // </SnippetDisplayResults>
        }
